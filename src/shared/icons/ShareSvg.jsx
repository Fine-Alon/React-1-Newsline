...
export const ShareSvg = (props) => {
    const [dimensions, setDimensions] = React.useState({width: 12, height: 14})
    ...
    return <svg width={dimensions.width} height={dimensions.height} viewBox="0 0 12 14" fill="none"
