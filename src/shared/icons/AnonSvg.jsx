...
export const AnonSvg = (props) => {
    const [dimensions, setDimensions] = React.useState({width: 50, height: 50})
    ...
    return <svg width={dimensions.width} height={dimensions.height} viewBox="0 0 50 50" fill="none"
